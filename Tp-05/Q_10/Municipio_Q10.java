...
class Municipio_Q10{
  ...
  public static void main (String[]args)throws Exception{
    ...
    tempo = tempo2 - tempo;
    Arq.openWrite("529934_bolha.txt");
...
class ListaMunicipio{
  ...
  public int getMaior(){
    int maior = vet[0].getNumeroFuncionarios();
    for(int i = 1; i < n; i++){
      if (vet[i].getNumeroFuncionarios() > maior){
        maior = vet[i].getNumeroFuncionarios();
      }
    }
    return maior;
  }

  public int[] bolha(int[] cont2) {
    for(int i = (n - 1); i > 0; i--) {
      for(int j = 0; j < i; j++) {
        if(vet[j].getEscolaridade() == "Pós-graduação"){ 
          if(vet[j + 1].getEscolaridade() == "Ensino superior completo" || vet[j + 1].getEscolaridade() == "Ensino médio completo" || vet[j + 1].getEscolaridade() == "Ensino fundamental completo" || vet[j + 1].getEscolaridade() == "Ensino superior incompleto" || vet[j + 1].getEscolaridade() == "Ensino médio incompleto" || vet[j + 1].getEscolaridade() == "Ensino fundamental incompleto" || vet[j + 1].getEscolaridade() == "-") {
            swap(j, j+1);
            cont2[0] = cont2[0] + 1;
            cont2[1] = cont2[1] + 1;
          }
          else if (vet[j + 1].getEscolaridade() == "Pós-graduação"){
            if(vet[j].getID() > vet[j+1].getID()){
              swap(j, j+1);
              cont2[0] = cont2[0] + 1;
              cont2[1] = cont2[1] + 1;
            }  
        ...
        else if(vet[j].getEscolaridade() == "Ensino superior completo"){ 
          if(vet[j + 1].getEscolaridade() == "Ensino médio completo" || vet[j + 1].getEscolaridade() == "Ensino fundamental completo" || vet[j + 1].getEscolaridade() == "Ensino superior incompleto" || vet[j + 1].getEscolaridade() == "Ensino médio incompleto" || vet[j + 1].getEscolaridade() == "Ensino fundamental incompleto" || vet[j + 1].getEscolaridade() == "-") {
            swap(j, j+1);
            cont2[0] = cont2[0] + 1;
            cont2[1] = cont2[1] + 1;
          }
          else if (vet[j + 1].getEscolaridade() == "Ensino superior completo"){
            if(vet[j].getID() > vet[j+1].getID()){
              swap(j, j+1);
              cont2[0] = cont2[0] + 1;
              cont2[1] = cont2[1] + 1;
        ...
        else if(vet[j].getEscolaridade() == "Ensino superior incompleto"){ 
          if(vet[j + 1].getEscolaridade() == "Ensino médio completo" || vet[j + 1].getEscolaridade() == "Ensino fundamental completo" || vet[j + 1].getEscolaridade() == "Ensino médio incompleto" || vet[j + 1].getEscolaridade() == "Ensino fundamental incompleto" || vet[j + 1].getEscolaridade() == "-") {
            swap(j, j+1);
            cont2[0] = cont2[0] + 1;
            cont2[1] = cont2[1] + 1;
          }
          else if (vet[j + 1].getEscolaridade() == "Ensino superior incompleto"){
            if(vet[j].getID() > vet[j+1].getID()){
              swap(j, j+1);
              cont2[0] = cont2[0] + 1;
              cont2[1] = cont2[1] + 1;
        ...
        else if (vet[j].getEscolaridade() == "Ensino médio completo"){ 
          if(vet[j + 1].getEscolaridade() == "Ensino fundamental completo" || vet[j + 1].getEscolaridade() == "Ensino médio incompleto" || vet[j + 1].getEscolaridade() == "Ensino fundamental incompleto" || vet[j + 1].getEscolaridade() == "-") {
            swap(j, j+1);
            cont2[0] = cont2[0] + 1;
            cont2[1] = cont2[1] + 1;
          }
          else if (vet[j + 1].getEscolaridade() == "Ensino médio completo"){
            if(vet[j].getID() > vet[j+1].getID()){
              swap(j, j+1);
              cont2[0] = cont2[0] + 1;
              cont2[1] = cont2[1] + 1;
        ...
        else if (vet[j].getEscolaridade() == "Ensino médio incompleto"){ 
          if(vet[j + 1].getEscolaridade() == "Ensino fundamental completo" || vet[j + 1].getEscolaridade() == "Ensino fundamental incompleto" || vet[j + 1].getEscolaridade() == "-") {
            swap(j, j+1);
            cont2[0] = cont2[0] + 1;
            cont2[1] = cont2[1] + 1;
          }
          else if (vet[j + 1].getEscolaridade() == "Ensino médio incompleto"){
            if(vet[j].getID() > vet[j+1].getID()){
              swap(j, j+1);
              cont2[0] = cont2[0] + 1;
              cont2[1] = cont2[1] + 1;
        ...
        else if(vet[j].getEscolaridade() == "Ensino fundamental completo"){
          if(vet[j + 1].getEscolaridade() == "Ensino fundamental incompleto" || vet[j + 1].getEscolaridade() == "-") {
            swap(j, j+1);
            cont2[0] = cont2[0] + 1;
            cont2[1] = cont2[1] + 1;
          }
          else if (vet[j + 1].getEscolaridade() == "Ensino fundamental completo"){
            if(vet[j].getID() > vet[j+1].getID()){
              swap(j, j+1);
              cont2[0] = cont2[0] + 1;
              cont2[1] = cont2[1] + 1;
        ...
        else if(vet[j].getEscolaridade() == "Ensino fundamental incompleto"){
          if(vet[j + 1].getEscolaridade() == "-") {
            swap(j, j+1);
            cont2[0] = cont2[0] + 1;
            cont2[1] = cont2[1] + 1;
          }
          else if (vet[j + 1].getEscolaridade() == "Ensino fundamental incompleto"){
            if(vet[j].getID() > vet[j+1].getID()){
              swap(j, j+1);
              cont2[0] = cont2[0] + 1;
              cont2[1] = cont2[1] + 1;
        ...
        else if (vet[j].getEscolaridade() == "-" && (vet[j + 1].getEscolaridade() == "-")){
          if(vet[j].getID() > vet[j+1].getID()){
            swap(j, j+1);
            cont2[0] = cont2[0] + 1;
            cont2[1] = cont2[1] + 1;
