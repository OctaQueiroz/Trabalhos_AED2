...
class Municipio_Q07{
  ...
  public static void main (String[]args)throws Exception{
    ...
    lista.heapsort(i,cont2);
    lista.mostrar();
    tempo2 = System.currentTimeMillis();
    tempo = tempo2 - tempo;
    Arq.openWrite("529934_heapsort.txt");
...
class ListaMunicipio{
  ...
  public int[] constroi(int tamHeap, int[] cont2){
    for(int i = tamHeap; i > 1; i /= 2){
      if(vet[i].getCodigoUF() > vet[i/2].getCodigoUF()){
        cont2[0] = cont2[0] + 1;
        swap(i, i/2);
        cont2[1] = cont2[1] + 1;
      }
      else if(vet[i].getCodigoUF() == vet[i/2].getCodigoUF()){
        cont2[0] = cont2[0] + 1;
        if(vet[i].getID() > vet[i/2].getID()){
          cont2[0] = cont2[0] + 1;          
          swap(i, i/2);
          cont2[1] = cont2[1] + 1;          
        }
  ...
  public int[] reconstroi(int tamHeap, int[] cont2){
    int i = 1, filho;
    while(i <= (tamHeap/2)){
      if (vet[2*i].getCodigoUF() > vet[2*i+1].getCodigoUF() || 2*i == tamHeap){
        cont2[0] = cont2[0] + 1;      
        filho = 2*i;
      }  
      else if(vet[2*i].getCodigoUF() == vet[2*i+1].getCodigoUF()){
        cont2[0] = cont2[0] + 1;        
        if(vet[2*i].getID() > vet[2*i+1].getID()){
          cont2[0] = cont2[0] + 1;          
          filho = 2*i;
        }
        else{
      ...
      if(vet[i].getCodigoUF() < vet[filho].getCodigoUF()){
        cont2[0] = cont2[0] + 1;        
        swap (i, filho);
        cont2[1] = cont2[1] + 1;
        i = filho;
      }  
      else if(vet[i].getCodigoUF() == vet[filho].getCodigoUF()){
        cont2[0] = cont2[0] + 1;        
        if(vet[i].getID() < vet[filho].getID()){
          cont2[0] = cont2[0] + 1;        
          swap(i, filho);
          cont2[1] = cont2[1] + 1;        
          i = filho;
  ...
  public void heapsort(int tam, int[] cont2) {
    //Alterar o vetor ignorando a posicao zero
    Municipio[] tmp = new Municipio[tam+1];
    for(int i = 0; i < n; i++){
      cont2[1] = cont2[1] + 1;      
      tmp[i+1] = vet[i].clone();
    }
    ...
    while(tamHeap > 1){
      ...
      swap(1, tamHeap--);
      cont2[1] = cont2[1] + 1;      
      reconstroi(tamHeap,  cont2);
    }

    //Alterar o vetor para voltar a posicao zero
    tmp = vet;
    vet = new Municipio[tam];
    for(int i = 0; i < tam; i++){
      vet[i] = tmp[i+1].clone();
      cont2[1] = cont2[1] + 1;
    }
