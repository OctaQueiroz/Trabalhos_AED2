...
class ListaMunicipio{
  ...
  public void radixSort(){
  		for(int digit = 0; digit < 3; digit ++){
  			int power = (int) Math.pow(10, digit+1);//atualizaçãi plano * 1000 + ID

  			Municipio z[][] = new Municipio[n][10];
  			int n[] = new int[10];
  ...
  // ver como funciona em: https://www.youtube.com/watch?v=8mA9tbThC74
